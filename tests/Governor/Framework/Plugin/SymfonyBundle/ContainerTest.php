...
class ContainerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testContainer()
    {
        ...
        $this->assertInstanceOf('Governor\Framework\Commanding\CommandBus',      $container->get('command_bus'));
        $this->assertInstanceOf('Governor\Framework\Eventing\EventMessageBus', $container->get('litecqrs.event_message_bus'));
    }
